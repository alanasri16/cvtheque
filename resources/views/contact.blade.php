...
@section('content')
    ...
    <a href="http://localhost:8000 ">  <center>   <h1>Contact </h1></center></a>
    <center>
    <a href="http://localhost:8000/service "><img src="../back.png"  style="width:50px;height:50px;"></a>
    <a href="http://localhost:8000/accueil "><img src="../next.png"  style="width:50px;height:50px;"></a>
    </center>
    <br>
    <div>
